# Guidance — 12_Management.md (full profile)
...
- Ch 9 §9.10 and ch 11 §11.7 are finished before you are dispatched (W7 after W6). If either file or section is nevertheless missing, report `STATUS: blocked` rather than guessing at technical risks or tools that were never written.
...
8. Read the template `12-management.md`; reproduce §12.1–§12.11 plus Open Decisions. Self-check against `ch12-management.md`, `ch12-monetization.md`, `ch12-liveops.md` (skip the monetisation/liveops checklists if those sections are one-liners per the Depth rule).
