...
## Consistency
- [ ] NA-05 Character motivations stated in §5.6 do not contradict each other across entries
- [ ] NA-06 Dialogue/delivery style described in §5.8 matches the personality stated for each character in §5.6
- [ ] NA-07 World lore and backstory (§5.4) does not contradict Setting/World Overview (§5.2)
...
- [ ] NA-14 No historical, religious, or real-world claim is asserted as fact without a data file citation

## Consistency rules
- [ ] NA-15 [Rule 1] Story terms match the Glossary from ch3 §3.10
- [ ] NA-16 [Rule 6] Any UNDECIDED narrative-relevant field this chapter touches appears in its Open Decisions box
