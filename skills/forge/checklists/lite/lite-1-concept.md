...
## Feature Set & Scope
- [ ] LC-06 Feature Set (§1.5) table has priority and pillar columns filled for every row
- [ ] LC-07 Every D-43 item appears as P0; every D-44 item appears only under "Explicitly out," never as a feature
- [ ] LC-08 Genre & Comparables (§1.6) states one thing to borrow and one to avoid per D-13 title, or states plainly that D-13 = none
...
- [ ] LC-11 Scope & Glossary Seed (§1.9) has 8–15 terms and every content count tagged "(est.)"
