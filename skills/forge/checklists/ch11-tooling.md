...
- [ ] TO-06 Content & Asset Pipeline Tools (§11.3) name validators for the naming/metadata conventions defined in ch10 §10.8
...
## Debug & QA Tooling
- [ ] TO-09 Debug, Telemetry & Live Tools (§11.5) references analytics hooks needed for the LiveOps plan (ch12 §12.7) when D-24 ≠ None
